    ...
    <TouchableWithoutFeedback onPress={() => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.relative}>
          ...
          >
            {/* Carte de fond */}
            <Text color="#6b7280">Carte OpenStreetMap</Text>
            <Text size="sm" color="#6b7280" style={styles.mt4}>
              Position approximative des vélos
            </Text>
            
            {/* Carte simplifiée avec OpenStreetMap */}
            <View 
              style={[
                styles.wT100,
                styles.hT100,
                ...
                { top: 0, left: 0 },
                {
                  backgroundImage: `url('https://tile.openstreetmap.org/{z}/{x}/{y}.png')`,
