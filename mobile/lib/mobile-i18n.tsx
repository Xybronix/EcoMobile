...
const translations: Translations = {
  ...
  'subscription.plans.hourlyRate': { fr: 'Tarif horaire : {rate} XOF/h', en: 'Hourly rate: {rate} XOF/h' },
  'subscription.plans.discount': { fr: 'Réduction : {discount}%', en: 'Discount: {discount}%' },
